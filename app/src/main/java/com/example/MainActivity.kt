...
import com.example.data.local.theme.SharedPreferencesThemePreferencesManager
...
import com.example.ui.screen.MainAppScreen
import com.example.ui.theme.CleanArchitectureTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CleanArchitectureTheme(themeMode = themeMode) {
                MainAppScreen(
    ...
    private fun handleNotificationIntent(intent: Intent?) {
        if (intent == null) return
        val title = intent.getStringExtra(com.example.data.service.AppFirebaseMessagingService.EXTRA_NOTIFICATION_TITLE)
            ?: intent.getStringExtra("title")
            ?: intent.getStringExtra("gcm.notification.title")
        val body = intent.getStringExtra(com.example.data.service.AppFirebaseMessagingService.EXTRA_NOTIFICATION_BODY)
